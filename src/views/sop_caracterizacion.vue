...
<div>
    ...
    <div class="container" :aria-busy="guardando">
        ...
        <div class="row">
            ...
            <h4>Visita</h4>
            <div class="col-6">
                <select id="visita" name="visita" class="form-select" aria-label="Default select example" v-model="visita">
            ...
            <div class="col-6" v-if="visita == 'efectiva'">
                <select id="tipovisita" name="tipovisita" class="form-select" aria-label="Default select example" v-model="tipovisita">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="col-6">
                                ...
                                <input type="text" class="form-control" id="numeroDocumento" v-model="nuevoMiembro.numeroDocumento" />
                            </div>
                            <div class="col-6">
                                <label for="fnacimiento" class="form-label">Fnacimiento</label>
                                <input type="date" class="form-control" id="fnacimiento" :max="new Date().toISOString().split('T')[0]" v-model="nuevoMiembro.fnacimiento" />
                            </div>
                            <div class="col-6">
    ...
    <div class="container">
        <div class="row">
            ...
            <select id="evacunal" name="evacunal" class="form-select" aria-label="Default select example" v-model="Evacunal">
                <option selected value="">Seleccione</option>
