    ...
    <div class="container">
        ...
        <div class="tab-content" id="nav-tabContent">
            <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab" tabindex="0">
                <h1 class="display-6"><i class="bi bi-people-fill display-6"></i> Listado de usuarios del sistema</h1>
                ...
                <div style="max-height: 700px; overflow-y: auto" class="p-2">
                    ...
                    <div v-else class="row">
                        <div v-for="(usuariosGrupo, grupo) in usuariosAgrupadosPorGrupo" :key="grupo" class="col-12 col-md-6 col-lg-4 mb-4">
                            <div class="card h-100" :class="getColorClassByGrupo(grupo)">
                                ...
                                <div class="card-body p-0">
                                    <div class="list-group list-group-flush">
                                        <div v-for="(user, index) in usuariosGrupo" :key="index" class="list-group-item d-flex justify-content-between align-items-center py-3">
                                            <div>
                                            ...
                                            <div class="d-flex flex-column align-items-end">
                                                <div class="btn-group-vertical" role="group">
                                                    <button class="btn btn-warning mb-1" @click="resetPassword(user.email)" title="Restablecer contraseña">
                                                        <i class="bi bi-key-fill"></i>
                                                    </button>
                                                    <button class="btn btn-danger" @click="deleteUser(user)" title="Eliminar usuario">
