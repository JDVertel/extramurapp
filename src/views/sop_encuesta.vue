      ...
      <form @submit.prevent="addRegistroEncuesta">
        <div class="row">
          ...
          <div class="col-6 col-md-3">
            <button class="btn btn-primary mt-4" @click="consultar">
        ...
        <div class="container" style="background-color: #f2e6ff; border-radius: 5px; border: 1px solid #ccc;">
          <div class="row mt-3 p-2">
            ...
            <div class="col-6 col-md-3 mb-3">
              ...
              <select id="regimen" v-model="regimen" class="form-select" required>
                <option value="">Seleccione</option>
                <option
                  v-for="(regimen, index) in Dregimen"
                  :key="index"
            ...
            <div class="col-12 col-md-3 mb-3">
              <label for="barrioVeredacomuna" class="form-label"
                >Barrio-vereda/comuna</label
              >
              <div class="horizontal">
                <select
                  id="barrioVeredacomuna"
                  v-model="barrioVeredacomuna"
                  class="form-select"
                  required
                >
                  <option value="">Seleccione</option>
                  <option
                    :value="option"
                    v-for="(option, index) in comunasBarrios"
                    :key="index"
                  >
            ...
            <div class="col-12 col-md-3 mb-3">
              ...
              <div class="row">
                <div class="col-10">
                  <select
                    id="poblacionRiesgo"
                    v-model="poblacionRiesgo"
                    class="form-select"
                  >
                    <option value="">Seleccione</option>
                    <option
                      :value="option2.nombre"
                      v-for="(option2, index) in poblacionRiesgoDisponibles"
                      :key="index"
                    >
                      {{ option2.nombre }}
                    </option>
              ...
              <div class="container comb_B">
                <ul class="list-group list-group-flush">
                  <li
                    ...
                    v-for="(list, index) in ListpoblacionRiesgo"
                    :key="index"
                  >
                    <button
                      type="button"
            ...
            <h6>Datos de Atención</h6>
            <hr />
            <div class="col-12 col-md-3 mb-3">
              <label for="tipoActividad" class="form-label"
              ...
              <div class="row">
                <div class="col-10">
                  <select id="tipoActividad" v-model="tipoActividad" class="form-select">
                    ...
                    <option
                      :value="option"
                      v-for="(option, index) in tipoActividadDisponibles"
                      :key="index"
                    >
                      {{ option.nombre }}
                    </option>
              ...
              <div class="container comb_A">
                <ul class="list-group list-group-flush">
                  <li
                    class="list-group-item"
                    v-for="(list, index) in ListtipoActividad"
                    :key="index"
                  >
                    <button
                      type="button"
            ...
            <div class="col-6 col-md-3 mb-3">
              <label for="desplazamiento" class="form-label"
                >¿Desplazamiento efectivo?</label
              >
              <select
                id="desplazamiento"
            ...
            <div class="col-6 col-md-3 mb-3">
              <label for="requiereRemision" class="form-label"
                >¿Requiere remisión a procedimiento?</label
              >
              <select
                id="requiereRemision"
                v-model="requiereRemision"
                class="form-select"
                required
              >
                <option value="" disabled>Seleccione</option>
            ...
            <div class="col-6 col-md-3 mb-3">
              ...
              <select id="requiereRemision" v-model="medico" class="form-select" required>
                <option value="">---Seleccione---</option>
                <option
                  v-for="medico in medicosByGrupo"
                  :key="medico.numDocumento"
            ...
            <div class="col-6 col-md-3 mb-3">
              ...
              >
                <option value="">---Seleccione---</option>
                <option
                  v-for="enfermero in enfermerosByGrupo"
                  :key="enfermero.numDocumento"
